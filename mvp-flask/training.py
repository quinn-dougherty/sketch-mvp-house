...
REPORTS = {'gradient boost performance': MetricReport(gbr.y_test.values, gbr.prediction).show,
           'random forest performance': MetricReport(rfr.y_test, rfr.prediction).show}
spin.stop()
